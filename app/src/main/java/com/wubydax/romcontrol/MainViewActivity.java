        ...
        * See more detailed instructions on the thread or in annotations to the previous method*/
        ...
        switch (position) {
            ...
            case 4:
                ...
                break;
            case 5:
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new ButtonsSwipeFragment()).commitAllowingStateLoss();
                break;
            case 6:
                ...
                break;
            case 7:
                getFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.container, new SoundControlFragment()).commitAllowingStateLoss();
                break;
            case 8:
